...
import { CACESReferential, Referential, Theme, Bloc } from '../types'; // Added for new methods and new types
...
export const StorageManager = {
  db: { // Expose db functions for referentiels, themes, blocs directly for convenience in UI components
    addReferential: db.addReferential.bind(db),
    getAllReferentiels: db.getAllReferentiels.bind(db),
    getReferentialByCode: db.getReferentialByCode.bind(db),
    addTheme: db.addTheme.bind(db),
    getAllThemes: db.getAllThemes.bind(db),
    getThemesByReferentialId: db.getThemesByReferentialId.bind(db),
    getThemeByCodeAndReferentialId: db.getThemeByCodeAndReferentialId.bind(db),
    addBloc: db.addBloc.bind(db),
    getAllBlocs: db.getAllBlocs.bind(db),
    getBlocsByThemeId: db.getBlocsByThemeId.bind(db),
    getBlocByCodeAndThemeId: db.getBlocByCodeAndThemeId.bind(db),
  },
  /**
