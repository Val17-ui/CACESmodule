import { addQuestion, getAllQuestions, getQuestionById, updateQuestion, deleteQuestion, QuestionWithId } from '../src/db'; // Adjusted path and extension
// Types are used for casting and defining sample data structure, not for runtime enum values here.
import { QuestionTheme, CACESReferential as ReferentialType } from '../src/types/index'; // Adjusted path and extension, ensured CACESReferential is aliased
