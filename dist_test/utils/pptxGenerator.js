...
async function findNextAvailableSlideLayoutId(zip) {
...
async function ensureOmbeaSlideLayoutExists(zip) {
...
async function updateSlideMasterRelsForNewLayout(zip, layoutFileName, rId) {
    const masterRelsFile = zip.file('ppt/slideMasters/_rels/slideMaster1.xml.rels');
    if (masterRelsFile) {
...
async function updateSlideMasterForNewLayout(zip, layoutId, rId) {
...
async function updateContentTypesForNewLayout(zip, layoutFileName) {
...
async function rebuildPresentationXml(zip, slideRIdMappings, existingSlideCount) {
...
async function updateAppXml(zip, metadata) {
...
async function updateCoreXml(zip, slideCount) {
...
export async function generatePPTX(templateFile, questions, options = {}) {
    try {
...
export async function testConsistency(templateFile, questions) {
...
export const handleGeneratePPTX = async (templateFile, questions) => {
    try {
