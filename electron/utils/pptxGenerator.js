...
exports.handleGeneratePPTX = void 0;
...
function escapeXml(unsafe) {
    if (!unsafe)
        return ''; // Gérer les chaînes vides ou null
...
function findNextAvailableSlideLayoutId(zip) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        layoutMatches.forEach(match => {
            var _a;
            const num = parseInt(((_a = match.match(/slideLayout(\d+)\.xml/)) === null || _a === void 0 ? void 0 : _a[1]) || '0');
            if (num > maxLayoutNum)
                maxLayoutNum = num;
        });
...
function createSlideXml(question, slideNumber, duration = 30) {
...
function calculateBaseTagNumber(slideNumber) {
...
function createSlideTagFiles(slideNumber, correctAnswer, duration = 30) {
...
function createSlideRelsXml(slideNumber, layoutFileName) {
    const baseTagNumber = calculateBaseTagNumber(slideNumber);
    return `<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
...
function rebuildPresentationXml(zip, slideRIdMappings, existingSlideCount) {
    return __awaiter(this, void 0, void 0, function* () {
...
function updatePresentationRelsWithMappings(originalContent, newSlideCount, existingSlideCount) {
...
function updateContentTypesComplete(originalContent, newSlideCount, existingSlideCount, layoutFileName, totalTags) {
...
function calculateAppXmlMetadata(existingSlideCount, questions) {
...
function updateHeadingPairsAndTitles(content, metadata) {
    let updated = content;
...
function createNewAppXml(zip, metadata) {
    ...
    const existingSlideTitles = []; // Pas de slides existantes dans un nouveau fichier
...
function updateCoreXml(zip, slideCount) {
    return __awaiter(this, void 0, void 0, function* () {
...
function generatePPTX(templateFile_1, questions_1) {
    return __awaiter(this, arguments, void 0, function* (templateFile, questions, options = {}) {
        try {
            ...
            const { layoutFileName, layoutRId } = yield ensureOmbeaSlideLayoutExists(outputZip);
            ...
            if (contentTypesFile) {
                const contentTypesContent = yield contentTypesFile.async('string');
                const updatedContentTypes = updateContentTypesComplete(contentTypesContent, questions.length, existingSlideCount, layoutFileName, totalTagsCreated);
            ...
            if (presentationRelsFile) {
                ...
                yield rebuildPresentationXml(outputZip, slideRIdMappings, existingSlideCount);
            }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (let i = 0; i < 5; i++) {
            ...
            try {
                ...
                const templateCopy = new File([yield templateFile.arrayBuffer()], templateFile.name, {
                    type: templateFile.type
                });
                yield generatePPTX(templateCopy, questions, {
...
const handleGeneratePPTX = (templateFile, questions) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield generatePPTX(templateFile, questions, {
...
exports.handleGeneratePPTX = handleGeneratePPTX;
